...
class LoMediumCameraIsisLabelNaifSpiceDriver():
    ...
    def instrument_id(self):
        ...
        lo_table = {'Lunar Orbiter 1': 'LO1_MEDIUM_RESOLUTION_CAMERA',
                    'Lunar Orbiter 2': 'LO2_MEDIUM_RESOLUTION_CAMERA',
                    'Lunar Orbiter 3': 'LO3_MEDIUM_RESOLUTION_CAMERA',
                    'Lunar Orbiter 4': 'LO4_MEDIUM_RESOLUTION_CAMERA',
                    'Lunar Orbiter 5': 'LO5_MEDIUM_RESOLUTION_CAMERA'}

        lookup_table = {'Medium Resolution Camera': lo_table[self.spacecraft_name]}
